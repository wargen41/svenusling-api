...
class Routes
{
    public static function register(App $app)
    {
        ...
        $app->get('/movies/hidden', [MovieController::class, 'listHiddenMovies'])->add(new AuthMiddleware());
        $app->get('/movies/latest', [MovieController::class, 'listLatestMovies'])->add(new AuthMiddleware());
        ...
        $app->get('/admin/episode/{id}', [AdminController::class, 'episodeDetails'])->add(new AdminAuthMiddleware());
